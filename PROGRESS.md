...
Последний коммит на момент этой заметки: `197c5c3`
(feat(logs): «Отметить началом менструации» из шторки пустого дня).
Локальный `main` = `origin/main` = прод. В прод-бандле
`index-CLg17ntC.js`.
