...
1. Продолжаем прогон живыми пользователями, собираем баги/фичи.
2. Uptime-мониторинг (QUESTIONS.md #4) — только после стабилизации.
3. Миграция в РФ (QUESTIONS.md #2) — только перед публичным анонсом.

## Где остановились в коде

Последний коммит: `f95ebc5` (fix(calendar): intent-flow). Working
tree чист, локальный main = origin/main = прод.
